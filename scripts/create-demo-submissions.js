...
const demoSubmissions = [
  {
    ...
    description:
      "Modern warehouse facility with state-of-the-art security and climate control systems. Perfect for e-commerce and logistics companies.",
    ...
    documents: {
      gst_certificate:
        "https://via.placeholder.com/400x300?text=GST+Certificate",
      property_papers:
        "https://via.placeholder.com/400x300?text=Property+Papers",
      fire_certificate:
        "https://via.placeholder.com/400x300?text=Fire+Certificate",
      validation: {
        gst_certificate: {
  ...
  },
  {
    ...
    description:
      "Large-scale warehouse with excellent connectivity to major highways and ports. Ideal for import-export businesses.",
    ...
    documents: {
      ...
      validation: {
        ...
        property_papers: {
          ...
          confidence: 0.87,
          is_valid: false,
          anomalies: ["Document appears to be expired"],
        },
        fire_certificate: {
          text: "Fire Certificate",
          confidence: 0.93,
  ...
  },
  {
    ...
    description:
      "Technology-enabled warehouse with IoT monitoring and automated systems. Perfect for modern businesses.",
...
async function createDemoSubmissions() {
  ...
  try {
    ...
    for (const submission of demoSubmissions) {
      ...
      if (error) {
        console.error(
          `❌ Error creating submission "${submission.name}":`,
          error,
        );
      } else {
        console.log(
          `✅ Created submission: "${submission.name}" (ID: ${data.id})`,
        );
      }
    }
