...
const submissions = JSON.parse(
  localStorage.getItem("demo-submissions") || "[]",
);
const approvedWarehouses = JSON.parse(
  localStorage.getItem("approved-warehouses") || "[]",
);
  ...
  const testSubmissions = [
    {
      ...
      description:
        "Modern warehouse facility with AI-powered security and climate control",
