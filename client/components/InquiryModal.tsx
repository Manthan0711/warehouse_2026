  ...
  const InquiryTypeCard = ({
    ...
    >
      <CardContent className="p-4 text-center">
        <Icon
          className={`h-8 w-8 mx-auto mb-2 ${isSelected ? "text-blue-400" : "text-gray-400"}`}
        />
        <h3
          className={`font-semibold text-sm ${isSelected ? "text-white" : "text-gray-200"}`}
        >
          {title}
        </h3>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-gray-900 border-gray-700 text-white">
        <DialogHeader className="border-b border-gray-700 pb-4">
          <DialogTitle className="flex items-center space-x-2 text-white">
            ...
            <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Send Inquiry to Warehouse Owner
            </span>
          </DialogTitle>
        ...
        <div className="space-y-6 pt-4">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-center space-x-4 mt-2">
                    ...
                    >
                      {availableArea.toLocaleString()} sq ft available
                    </Badge>
                  </div>
                </div>
              </div>
          ...
          <div>
            <Label className="text-base font-semibold mb-3 block text-gray-200">
              Select Inquiry Type
            </Label>
          ...
          <div className="space-y-4">
            ...
            {inquiryType === "booking" && (
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="requiredSpace" className="text-gray-300">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("requiredSpace", e.target.value)
                    }
                    placeholder="1000"
                    required
                    className="bg-gray-800 border-gray-600 text-white placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500"
          ...
          <div className="border-t border-gray-700 pt-6">
            <Label className="text-base font-semibold mb-4 block text-gray-200">
              Contact Owner
            </Label>
            ...
            formData.duration && (
              <Card className="bg-gray-800/80 border-blue-900/50">
                <CardHeader className="pb-3 bg-gradient-to-r from-blue-900/30 to-indigo-900/30 rounded-t-lg">
                  <CardTitle className="text-sm bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                    Cost Estimate
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between text-gray-300">
                      ...
                      <span className="font-medium text-white">
                        ₹
                        {(
                          parseInt(formData.requiredSpace) * pricePerSqFt
                        ).toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between text-gray-300">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      *Estimated cost. Final pricing may include additional
                      charges for utilities, security deposit, etc.
                    </p>
                  </div>
                </CardContent>
              </Card>
