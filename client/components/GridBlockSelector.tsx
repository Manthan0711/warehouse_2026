            ...
            return (
              <button
                ...
                title={
                  isBooked
                    ? "Already booked"
                    : `${block.label} - ${block.area.toLocaleString()} sq ft`
                }
                className={`
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span
                    className={`text-[10px] font-bold ${isBooked ? "text-red-400" : isSelected ? "text-white" : "text-slate-400"}`}
                  >
                    {block.label}
                  </span>
                </div>
        ...
        {selectedBlocks.size > 0 ? (
          <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border border-green-500/30 rounded-lg p-3 space-y-2">
            ...
            >
              ...
              Book {selectedBlocks.size} Block
