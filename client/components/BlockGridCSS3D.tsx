...
export default function BlockGridCSS3D({
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    if (
      (e.button === 0 && !e.target) ||
      !(e.target as HTMLElement).closest(".block-cell")
    ) {
      setIsDragging(true);
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              transform:
                "translateZ(-30px) translateX(-10px) translateY(-10px)",
            }}
          />
          ...
          <div
            ...
            style={{
              ...
              height: `${rows * 50 + 20}px`,
              transform:
                "translateZ(-29px) translateX(-10px) translateY(-10px)",
              backgroundImage: `
          ...
          >
            {blocks.map((block, index) => {
              ...
              const isClickable =
                block.status === "available" && isSelectionMode;
              ...
              return (
                <div
                  ...
                  onClick={() =>
                    isClickable && onBlockSelect(block.block_number)
                  }
                ...
                >
                  ...
                  >
                    <span
                      className={cn(
                        "font-bold text-xs",
                        isSelected || block.status === "booked"
                          ? "text-white"
                          : "text-gray-900",
                      )}
                    >
