      ...
      <Card className="bg-gray-800 border-gray-700">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-gray-400 text-sm">
            Click "Start Selection" and then click on available blocks in the 3D
            grid to start building your booking.
          </p>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="space-y-4 pt-4">
        ...
        <div>
          <h4 className="text-sm font-medium text-gray-400 mb-2">
            Selected Blocks ({selectedBlocksCount})
          </h4>
          <div className="flex flex-wrap gap-1 max-h-20 overflow-y-auto">
            {selectedBlocks.slice(0, 15).map((blockNumber) => (
              <Badge
                key={blockNumber}
                variant="outline"
                className="bg-blue-500/20 text-blue-300 border-blue-500 text-xs"
              >
                #{blockNumber}
              </Badge>
            ))}
            {selectedBlocks.length > 15 && (
              <Badge
                variant="outline"
                className="bg-gray-500/20 text-gray-300 border-gray-500 text-xs"
              >
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">
            Choose the type of goods you will store in this warehouse.
          </p>
        </div>
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between text-gray-300">
            <span>
              {totalAreaSqFt.toLocaleString()} sq ft × ₹{blockPrice}
            </span>
          ...
          <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
            ...
            <DialogContent className="bg-gray-800 border-gray-700 text-white max-w-md">
              ...
              <div className="space-y-4">
                ...
                {/* Payment Method */}
                <div>
                  <h4 className="font-medium text-gray-300 mb-2 text-sm">
                    Payment Method
                  </h4>
                  <div className="space-y-2">
                ...
                <div className="bg-gray-700/50 p-3 rounded-lg text-sm">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <Badge className="ml-1 bg-yellow-500/20 text-yellow-300 text-xs">
                        Pending Approval
                      </Badge>
                    </div>
                  </div>
                ...
                <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-3 text-xs text-blue-200">
                  <p>
                    📋 Your booking will be sent for admin approval. Once
                    approved, the warehouse owner will receive your booking
                    details and you'll get a confirmation email.
                  </p>
                </div>
