      ...
      <Alert className="mb-4 bg-green-50 dark:bg-green-950 border-green-200 dark:border-green-800">
        ...
        <AlertDescription className="mt-2 text-green-700 dark:text-green-300">
          ...
          <ul className="list-disc list-inside space-y-1 mb-2">
            {openRouterKey && (
              <li>
                <strong>OpenRouter</strong> - Claude 3.5 Sonnet (Best quality)
              </li>
            )}
            {groqKey && (
              <li>
                <strong>Groq</strong> - Llama 3.3 70B (Fastest)
              </li>
            )}
            {geminiKey && (
              <li>
                <strong>Gemini</strong> - Pro model
              </li>
            )}
            {cloudflareKey && (
              <li>
                <strong>Cloudflare</strong> - Workers AI
              </li>
            )}
          </ul>
  ...
  return (
    <Alert className="mb-4 bg-amber-50 dark:bg-amber-950 border-amber-200 dark:border-amber-800">
      ...
      <AlertDescription className="mt-2 text-amber-700 dark:text-amber-300">
        <p className="mb-3">
          You're currently seeing simulated recommendations. For real AI-powered
          features, configure at least one API key:
        </p>
        ...
        <div className="space-y-3 mb-3">
          <div className="border border-amber-200 dark:border-amber-700 rounded p-2 bg-white/50 dark:bg-black/20">
            ...
            <p className="text-sm mb-2">
              Access to Claude 3.5 Sonnet, GPT-4, and 100+ models
            </p>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="border border-amber-200 dark:border-amber-700 rounded p-2 bg-white/50 dark:bg-black/20">
            ...
            <p className="text-sm mb-2">
              Lightning-fast Llama 3.3 70B responses
            </p>
            <Button
              variant="outline"
              size="sm"
          ...
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>
              ...
              <ul className="list-disc list-inside ml-4 mt-1">
                <li>
                  <code>VITE_OPENROUTER_API_KEY=your_key</code>
                </li>
                <li>
                  <code>VITE_GROQ_API_KEY=your_key</code>
                </li>
                <li>
