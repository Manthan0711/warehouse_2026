...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  useEffect(() => {
    ...
    if (theme === "professional") {
      ...
      body.style.background =
        "linear-gradient(135deg, #0c1222 0%, #153366 100%)";
      ...
      body.style.background =
        "linear-gradient(135deg, hsl(225, 32%, 7%) 0%, hsl(229, 35%, 10%) 100%)";
  ...
  return (
    <ThemeContext.Provider
      value={{ theme, toggleTheme, setProfessionalTheme, isProfessional }}
    >
      {children}
    </ThemeContext.Provider>
  );
