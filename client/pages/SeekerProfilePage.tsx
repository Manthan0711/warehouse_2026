...
export default function SeekerProfilePage() {
  ...
  const completionChecks = [
    ...
    profile.company_name.trim().length > 0 ||
      profile.business_type.trim().length > 0,
      ...
      try {
        ...
        if (data) {
          setProfile((prev) => ({
            ...
            ...data,
            full_name:
              data.full_name || baseProfile?.name || prev.full_name || "",
            email:
              data.email ||
              baseProfile?.email ||
              user.email ||
  ...
  const validateBeforeVerificationSubmit = () => {
    if (!profile.full_name.trim() || !profile.phone.trim()) {
      toast({
        ...
        description:
          "Please fill full name and phone number before submitting.",
        variant: "destructive",
      });
      return false;
    }
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400 mt-1">
              Complete your profile to book warehouses
            </p>
          </div>
        ...
        <div className="glass-dark rounded-xl p-5 mb-6 border border-slate-700/60">
          ...
          <p className="text-xs text-slate-400 mt-2">
            Add business preferences and at least one document to improve
            matching and verification speed.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-red-300 text-sm mt-2 font-medium">
                  ⚠️ You cannot book any warehouses until your profile is
                  verified.
                </p>
              </div>
            </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 mb-6 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm">
                You must verify your profile before booking warehouses. Complete
            ...
            <div className="flex flex-wrap gap-2">
              {DISTRICTS.map((district) => (
                <button
                  key={district}
                  onClick={() =>
                    toggleArrayItem("preferred_districts", district)
                  }
                  className={`px-3 py-1.5 rounded-full text-sm transition-all ${
                    profile.preferred_districts.includes(district)
            ...
            <div className="flex flex-wrap gap-2">
              {WAREHOUSE_TYPES.map((type) => (
                <button
                  key={type}
                  onClick={() =>
                    toggleArrayItem("preferred_warehouse_types", type)
                  }
                  className={`px-3 py-1.5 rounded-full text-sm transition-all ${
                    profile.preferred_warehouse_types.includes(type)
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile((prev) => ({
                    ...prev,
                    required_area_min: e.target.value
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile((prev) => ({
                    ...prev,
                    required_area_max: e.target.value
                      ? Number(e.target.value)
                      : null,
                  }))
                }
        ...
        <div className="glass-dark rounded-xl p-6 mb-6">
          ...
          <p className="text-slate-400 text-sm mb-4">
            Upload business registration, GST certificate, or ID proof to get
            verified.
          </p>
