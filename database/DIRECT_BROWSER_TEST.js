...
fetch(
  "https://your-supabase-url.supabase.co/rest/v1/warehouses?select=name,city,state,status,submission_id&submission_id=not.is.null",
  {
    headers: {
...
fetch(
  "https://your-supabase-url.supabase.co/rest/v1/warehouse_submissions?select=name,city,status&status=eq.approved",
  {
    headers: {
      apikey: "your-anon-key",
      Authorization: "Bearer your-anon-key",
